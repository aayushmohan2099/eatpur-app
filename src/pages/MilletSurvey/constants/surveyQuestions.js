export const SURVEY_SECTIONS = [
    {
        ...
        title: "Basic Profile",
        description:
            "Help us understand who you are and your household profile.",
...

    {
        ...
        description:
            "Tell us about your food preferences and health awareness.",

        questions: [
            {
                id: "healthConsciousness",
                question:
                    "How health-conscious are you regarding daily food choices?",
                type: "rating",
...

            {
                id: "healthyProducts",
                question:
                    "Which healthy food products do you already buy regularly?",
...

            {
                id: "milletExperience",
                question:
                    "Have you consumed millet-based foods before?",
...

            {
                id: "milletReasons",
                question:
                    "Why would you choose millet foods?",
...

    {
        ...
        description:
            "Help us understand the challenges around millet consumption.",

        questions: [
            {
                id: "painPoints",
                question:
                    "What prevents you from consuming millet foods more often?",
...

            {
                id: "eatingHabit",
                question:
                    "Which statement best matches your current eating habits?",
...

    {
        ...
        description:
            "Tell us what products and attributes matter most to you.",
        ...
        questions: [
            {
                ...
                question:
                    "Which Eatpur products would you most likely try?",
...

            {
                ...
                question:
                    "What matters MOST while buying healthy packaged food?",
...

            {
                ...
                question:
                    "Which packaging style appeals most to you?",
...

    {
        ...
        questions: [
...

            {
                ...
                question:
                    "Where would you prefer buying Eatpur products?",
...

            {
                ...
                question:
                    "How likely are you to try Eatpur products?",
...

    {
        ...
        description:
            "Stay connected with Eatpur Naturals and receive updates.",
        ...
        questions: [
...

            {
                ...
                question:
                    "Share your WhatsApp Number (Optional)",
...

            {
                ...
                question:
                    "Any suggestions for Eatpur Naturals?",
