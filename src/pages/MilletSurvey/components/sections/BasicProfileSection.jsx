...
const BasicProfileSection = ({ formData, updateField, errors }) => {
  const section = SURVEY_SECTIONS.find((item) => item.key === "basicProfile");

  const ageQuestion = section.questions.find((q) => q.id === "ageGroup");

  const cityQuestion = section.questions.find((q) => q.id === "city");

  const profileQuestion = section.questions.find((q) => q.id === "profileType");

  const familyQuestion = section.questions.find((q) => q.id === "familyType");
    ...
    >
      ...
      <div className="space-y-10">
        ...
        <TextInputField
          ...
          placeholder={cityQuestion.placeholder}
        ...
        <RadioGroupField
          ...
          required={profileQuestion.required}
          columns={2}
        ...
        <RadioGroupField
          ...
          required={familyQuestion.required}
          columns={2}
      ...
      >
        ...
        >
          ...
          <p
            ...
            "
          >
            Your responses help us understand who our future customers are and
            how we can build healthier millet foods for Indian families.
          </p>
        </div>
      </div>
    </motion.div>
