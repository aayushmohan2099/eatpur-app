...
export default function FooterCTA() {
  ...
  const opacity = useTransform(scrollYProgress, [0.8, 0.85, 1], [0, 1, 1]);
  const y = useTransform(scrollYProgress, [0.8, 0.85, 1], [50, 0, 0]);
  ...
  return (
    ...
    >
      <div className="max-w-2xl flex flex-col items-center bg-gradient-radial/50 from-[#040704]/90 to-transparent p-8 rounded-3xl backdrop-blur-[2px]">
        <h2 className="text-5xl md:text-7xl font-bold tracking-tight text-[#FFF8E1] mb-4 drop-shadow-[0_8px_35px_rgba(0,0,0,0.95)]">
          Pure food. Honest living.
        </h2>
        <div className="bg-black/20 py-2 mb-8">
          <h3 className="text-xl md:text-2xl text-eatpur-gold font-medium drop-shadow-[0_6px_25px_rgba(0,0,0,1)]">
        ...
        <p className="text-sm text-eatpur-text mt-8 opacity-80 drop-shadow-[0_8px_30px_rgba(0,0,0,1)]">
