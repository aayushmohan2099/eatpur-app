...
export default function LeafButton({
  ...
  return (
    <>
      <button
        className={`eatpur-leaf-btn ${className}`}
        onClick={onClick}
        {...props}
      >
        ...
        {/* Leaf 3 */}
        <div className="leaf-icon icon-3">
          <svg
            xmlns="http://www.w3.org/2000/svg"
        ...
        <style>{`
          .eatpur-leaf-btn {
            ...
            color: var(--color-eatpur-green-dark, #6B8E23);
            cursor: pointer;
            border: 2px solid var(--color-eatpur-green-dark, #6B8E23);
            border-radius: 8px;
          ...
          .eatpur-leaf-btn:hover {
            background: var(--color-eatpur-green-dark, #6B8E23);
            color: #ffffff;
          }
          ...
          .leaf-icon {
            ...
            /* Drop shadow matched to the current text/fill color */
          ...
          .eatpur-leaf-btn:hover .icon-1 {
            animation: slay-1 3s cubic-bezier(0.52, 0, 0.58, 1) infinite;
          }

          /* --- ICON 2 (Top Left Center) --- */
          .icon-2 {
            top: 0;
            left: 20px;
            width: 10px;
          ...
          .eatpur-leaf-btn:hover .icon-2 {
            animation: slay-2 3s cubic-bezier(0.52, 0, 0.58, 1) 1s infinite;
          }

          /* --- ICON 3 (Top Left Edge) --- */
          .icon-3 {
            top: 0;
            left: 0;
            width: 14px;
          ...
          .eatpur-leaf-btn:hover .icon-3 {
            animation: slay-3 2s cubic-bezier(0.52, 0, 0.58, 1) 1s infinite;
          }

          /* --- KEYFRAMES --- */
          @keyframes slay-1 {
            0% { transform: rotate(10deg) translateY(-30%); }
            50% { transform: rotate(-5deg) translateY(-30%); }
            100% { transform: rotate(10deg) translateY(-30%); }
          }
          @keyframes slay-2 {
            0% { transform: rotate(0deg) translateY(-20%); }
            50% { transform: rotate(15deg) translateY(-20%); }
            100% { transform: rotate(0deg) translateY(-20%); }
          }
          @keyframes slay-3 {
            0% { transform: rotate(0deg) translateY(-20%); }
            50% { transform: rotate(-5deg) translateY(-20%); }
            100% { transform: rotate(0deg) translateY(-20%); }
          }
        `}</style>
      </button>
