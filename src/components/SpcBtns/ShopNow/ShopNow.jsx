...
export default function ShopNowButton({ onClick }) {
  return (
    <button className="eatpur-shop-btn" onClick={onClick}>
      <div className="eatpur-bg"></div>
      ...
      <div className="eatpur-wrap">
        ...
        <div className="eatpur-outline"></div>

        <div className="eatpur-content">
          <span className="eatpur-char eatpur-state-1">
            <span data-label="S" style={{ "--i": 1 }}>
              S
            </span>
            <span data-label="h" style={{ "--i": 2 }}>
              h
            </span>
            <span data-label="o" style={{ "--i": 3 }}>
              o
            </span>
            <span data-label="p" style={{ "--i": 4 }}>
              p
            </span>
